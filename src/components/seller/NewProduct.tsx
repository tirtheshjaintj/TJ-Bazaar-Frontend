...
>
  {!isSubmitting ? (
    ...
    <div className="flex items-center justify-center">
     <div className='flex items-center'>Creating Product&nbsp;</div> <div className="spinner border-t-transparent border-solid animate-spin rounded-full border-white border-4 h-6 w-6"></div>
    </div>
  )}
</button>
